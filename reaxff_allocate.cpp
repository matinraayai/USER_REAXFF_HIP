        ...
        storage * const workspace, int local_cap )
{
    ...
    if ( control->ensemble == nhNVT )
    {
        workspace->v_const = static_cast<rvec*>(smalloc( local_rvec, "Allocate_Workspace_Part1::v_const" ));
    }
        ...
        storage * const workspace, int total_cap )
{
    ...
    workspace->total_bond_order = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::total_bo" ));
    workspace->Deltap = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Deltap" ));
    workspace->Deltap_boc = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Deltap_boc" ));
    workspace->dDeltap_self = static_cast<rvec*>(smalloc( total_rvec, "Allocate_Workspace_Part2::dDeltap_self" ));
    workspace->Delta = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Delta" ));
    workspace->Delta_lp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Delta_lp" ));
    workspace->Delta_lp_temp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Delta_lp_temp" ));
    workspace->dDelta_lp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::dDelta_lp" ));
    workspace->dDelta_lp_temp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::dDelta_lp_temp" ));
    workspace->Delta_e = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Delta_e" ));
    workspace->Delta_boc = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Delta_boc" ));
    workspace->nlp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::nlp" ));
    workspace->nlp_temp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::nlp_temp" ));
    workspace->Clp = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::Clp" ));
    workspace->CdDelta = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::CdDelta" ));
    workspace->vlpex = static_cast<real*>(smalloc( total_real, "Allocate_Workspace_Part2::vlpex" ));
    ...
    workspace->s = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::s" ));
    workspace->t = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::t" ));
    workspace->b = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::b" ));
    workspace->x = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::x" ));
    ...
    switch ( control->cm_solver_type )
    {
        case GMRES_S:
        case GMRES_H_S:
            workspace->y = static_cast<real*>(scalloc( control->cm_solver_restart + 1, sizeof(real), "Allocate_Workspace_Part2::y" ));
            workspace->z = static_cast<real*>(scalloc( control->cm_solver_restart + 1, sizeof(real), "Allocate_Workspace_Part2::z" ));
            workspace->g = static_cast<real*>(scalloc( control->cm_solver_restart + 1, sizeof(real), "Allocate_Workspace_Part2::g" ));
            workspace->h = static_cast<real**>(scalloc( SQR(control->cm_solver_restart + 1), sizeof(real*), "Allocate_Workspace_Part2::h"));
            workspace->hs = static_cast<real*>(scalloc( control->cm_solver_restart + 1, sizeof(real), "Allocate_Workspace_Part2::hs" ));
            workspace->hc = static_cast<real*>(scalloc( control->cm_solver_restart + 1, sizeof(real), "Allocate_Workspace_Part2::hc" ));
            workspace->v = static_cast<real**>(scalloc( SQR(control->cm_solver_restart + 1), sizeof(real*), "Allocate_Workspace_Part2::v"));
            break;

        case CG_S:
            workspace->r = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::r" ));
            workspace->d = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::d" ));
            workspace->q = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::q" ));
            workspace->p = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::p" ));
            workspace->r2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::r2" ));
            workspace->d2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::d2" ));
            workspace->q2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::q2" ));
            workspace->p2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::p2" ));
            break;
        ...
        case BiCGStab_S:
            workspace->y = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::y" ));
            workspace->g = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::g" ));
            workspace->z = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::z" ));
            workspace->r = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::r" ));
            workspace->d = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::d" ));
            workspace->q = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::q" ));
            workspace->p = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::p" ));
            workspace->r_hat = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::r_hat" ));
            workspace->q_hat = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::q_hat" ));
            break;
        ...
        case PIPECG_S:
            ...
            workspace->q = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::q" ));
            workspace->p = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::p" ));
            workspace->m = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::m" ));
            workspace->n = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::n" ));
            workspace->u = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::u" ));
            workspace->w = static_cast<real*>(scalloc( total_cap, sizeof(real), "Allocate_Workspace_Part2::w" ));
            workspace->z2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::z2" ));
            workspace->r2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::r2" ));
            workspace->d2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::d2" ));
            workspace->q2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::q2" ));
            workspace->p2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::p2" ));
            workspace->m2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::m2" ));
            workspace->n2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::n2" ));
            workspace->u2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::u2" ));
            workspace->w2 = static_cast<rvec2*>(scalloc( total_cap, sizeof(rvec2), "Allocate_Workspace_Part2::w2" ));
            break;
        ...
        int format )
{
    ...
    H->start = static_cast<int*>(smalloc( sizeof(int) * n_max, "Allocate_Matrix::start" ));
    H->end = static_cast<int*>(smalloc( sizeof(int) * n_max, "Allocate_Matrix::end" ));
    H->j = static_cast<int*>(smalloc( sizeof(int) * m, "Allocate_Matrix::j" ));
    H->val = static_cast<real*>(smalloc( sizeof(real) * m, "Allocate_Matrix::val" ));
}
...
void Allocate_Grid( reax_system * const system, MPI_Comm comm )
{
    ...
    g->order = static_cast<ivec*>(scalloc( g->total + 1, sizeof(ivec), "Allocate_Grid::g->order" ));

    /* allocate the gcells for the new grid */
    g->max_nbrs = (2 * g->vlist_span[0] + 1) * (2 * g->vlist_span[1] + 1)
        * (2 * g->vlist_span[2] + 1) + 3;

    g->cells = static_cast<grid_cell*>(scalloc( total, sizeof(grid_cell), "Allocate_Grid::g->cells" ));
    ...
    g->str = static_cast<int*>(scalloc( total, sizeof(int),"Allocate_Grid::grid->str" ));
    g->end = static_cast<int*>(scalloc( total, sizeof(int), "Allocate_Grid::grid->end" ));
    g->cutoff = static_cast<real*>(scalloc( total, sizeof(real), "Allocate_Grid::grid->cutoff" ));
    g->nbrs_x = static_cast<ivec*>(scalloc( total * g->max_nbrs, sizeof(ivec), "Allocate_Grid::grid->nbrs_x" ));
    g->nbrs_cp = static_cast<rvec*>(scalloc( total * g->max_nbrs, sizeof(rvec), "Allocate_Grid::grid->nbrs_cp" ));
    ...
    g->rel_box = static_cast<ivec*>(scalloc( total, sizeof(ivec), "Allocate_Grid::grid->rel_box" ));
