/*----------------------------------------------------------------------
  ...
  #include "reaxff_torsion_angles.h"
  #include "reaxff_valence_angles.h"
...
//            *H_sp_top = *H_sp_top + 1;
        ...
        case ACKS2_CM:
            X_diag = static_cast<real*>(smalloc( sizeof(real) * system->N,
                                                 __FILE__, __LINE__ ));
        ...
        output_controls *out_control )
{
    ...
    q = static_cast<int*>(smalloc( sizeof(int) * (system->N - system->n),
                                   __FILE__, __LINE__ ));
