...
/* Compute sym_index */
HIP_GLOBAL void k_bond_order_part3( storage workspace, reax_list bond_list, int N )
{
...
HIP_GLOBAL void k_total_forces_part1( storage workspace, reax_list bond_list,
        int N )
{
    int i, pj;
    rvec f_i;
