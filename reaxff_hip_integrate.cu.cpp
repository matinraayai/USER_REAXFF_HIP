...
HIP_GLOBAL void k_velocity_verlet_part2( reax_atom *my_atoms,
        single_body_parameters *sbp, real dt, int n )
{
    int i;
    reax_atom *atom;
...
HIP_GLOBAL void k_velocity_verlet_nose_hoover_nvt( reax_atom *my_atoms,
        single_body_parameters *sbp, real dt, int n )
{
    int i;
    real inv_m;
...
HIP_GLOBAL void k_velocity_verlet_nose_hoover_nvt( reax_atom *my_atoms, rvec * v_const,
...
HIP_GLOBAL void k_velocity_verlet_nose_hoover_nvt_part3( reax_atom *my_atoms, rvec *v_const,
...
HIP_GLOBAL void k_scale_velocites_berendsen_nvt( reax_atom *my_atoms, real lambda, int n )
{
    reax_atom *atom;
...
HIP_GLOBAL void k_scale_velocities_npt( reax_atom *my_atoms, real lambda,
