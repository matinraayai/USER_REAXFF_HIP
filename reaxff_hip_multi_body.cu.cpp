...
HIP_GLOBAL void k_atom_energy_part1( reax_atom const * const my_atoms, global_parameters gp,
...
/* Compute lone pair term */
HIP_GLOBAL void k_atom_energy_part1_opt( reax_atom const * const my_atoms, global_parameters gp,
        single_body_parameters const * const sbp, storage workspace,
        reax_list bond_list, int n, int num_atom_types, real * const e_lp_g )
{
...
HIP_GLOBAL void k_atom_energy_part2( reax_atom const * const my_atoms, global_parameters gp,
...
/* Compute over- and under-coordination terms */
HIP_GLOBAL void k_atom_energy_part2_opt( reax_atom const * const my_atoms, global_parameters gp,
        single_body_parameters const * const sbp, two_body_parameters const * const tbp,
        storage workspace, reax_list bond_list, int n, int num_atom_types,
        real * const e_ov_g, real * const e_un_g )
{
