...
HIP_DEVICE double Hip_Random( double range )
{
    //TODO: use cuRAND
...
HIP_DEVICE double Hip_GRandom( double mean, double sigma )
{
    double v1 = Hip_Random(2.0) - 1.0;
    double v2 = Hip_Random(2.0) - 1.0;
    double rsq = v1 * v1 + v2 * v2;

    while (rsq >= 1.0 || rsq == 0.0)
    {
        v1 = Hip_Random(2.0) - 1.0;
        v2 = Hip_Random(2.0) - 1.0;
        rsq = v1 * v1 + v2 * v2;
    }
