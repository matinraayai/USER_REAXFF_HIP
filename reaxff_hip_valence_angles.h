...
#ifndef __HIP_VALENCE_ANGLES_H_
...
int Hip_Compute_Valence_Angles( reax_system * const,
...
HIP_DEVICE static inline void Calculate_Theta( const rvec dvec_ji, real d_ji,
...
HIP_DEVICE static inline void Calculate_dCos_Theta( const rvec dvec_ji,
