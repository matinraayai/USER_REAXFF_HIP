        ...
        mpi_datatypes * const mpi_data )
{
    ...
    /* list management */
    system->far_nbrs = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                                  __FILE__, __LINE__ ));
    system->max_far_nbrs = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                                      __FILE__, __LINE__ ));

    system->bonds = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                               __FILE__, __LINE__ ));
    system->max_bonds = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                                   __FILE__, __LINE__ ));

    system->hbonds = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                                __FILE__, __LINE__ ));
    system->max_hbonds = static_cast<int*>(smalloc( sizeof(int) * system->total_cap,
                                                    __FILE__, __LINE__ ));

    system->cm_entries = static_cast<int*>(smalloc( sizeof(int) * system->local_cap,
                                                    __FILE__, __LINE__ ));
    system->max_cm_entries = static_cast<int*>(smalloc( sizeof(int) * system->local_cap,
                                                        __FILE__, __LINE__ ));
