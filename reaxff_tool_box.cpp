        ...
        char ***tokens, size_t num_tokens, size_t token_size )
{
    ...
    *line = static_cast<char*>(smalloc( sizeof(char) * line_size, "Allocate_Tokenizer_Space::*line" ));
    *backup = static_cast<char*>(smalloc( sizeof(char) * backup_size, "Allocate_Tokenizer_Space::*backup" ));
    *tokens = static_cast<char**>(smalloc( sizeof(char*) * num_tokens, "Allocate_Tokenizer_Space::*tokens" ));

    for ( i = 0; i < num_tokens; i++ )
    {
        (*tokens)[i] = static_cast<char*>(smalloc( sizeof(char) * token_size,
