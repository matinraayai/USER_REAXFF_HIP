        ...
        char ***tokens, size_t num_tokens, size_t token_size )
{
    ...
    *line = static_cast<char*>(smalloc( sizeof(char) * line_size, __FILE__, __LINE__ ));
    *backup = static_cast<char*>(smalloc( sizeof(char) * backup_size, __FILE__, __LINE__ ));
    *tokens = static_cast<char**>(smalloc( sizeof(char*) * num_tokens, __FILE__, __LINE__ ));
